...
Click through the tabs on the top of the page to explore the audio features of film music according to Spotify API, how they differ between action and comedy film music, and what else stands out.

Column {data-width=350}
-----------------------------------------------------------------------
```{r, out.width = "400px"}
knitr::include_graphics("action1.jpg")
```

```{r, out.width = "400px"}
knitr::include_graphics("comedy1.jpg")
```

Angry Action and Happy Comedy
==================================================
